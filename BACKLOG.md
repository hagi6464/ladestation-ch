...
4. ✅ **Trinkgeld** (erledigt 2026-06-04) — statischer TWINT-QR online nicht erlaubt (TWINT-Vorgabe) → stattdessen **Payrexx-Link** (TWINT + Karte) via Logo-Menü „❤️ Trinkgeld senden" → `DonationModal` (neuer Tab). Echte Payrexx-URL eingesetzt, live.
