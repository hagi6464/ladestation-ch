...
4. ✅ **Donation** (erledigt 2026-06-04) — statischer TWINT-QR online nicht erlaubt (TWINT-Vorgabe) → stattdessen **Payrexx-Spendenlink** (TWINT + Karte) via Logo-Menü „❤️ Spenden" → `DonationModal` (öffnet im neuen Tab). Offen: User trägt echten Payrexx-Link in `DONATION_URL` ein.
